...
def train():
    ...
    result_code = subprocess.call(["python", "run_model.py", '--task', 'traffic_state_pred', '--dataset', 'Xiongan_grid', '--exp_id', '50001'])
...
def predict():
    ...
    result_code = subprocess.call(["python", "test_model.py", '--task', 'traffic_state_pred', '--dataset', 'Xiongan_grid', '--exp_id', '50001', '--cache_model', './libcity/cache/50001/model_cache/GRU_Xiongan_grid.m'])
